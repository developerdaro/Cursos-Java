...
public class IniciarSesion extends javax.swing.JFrame {
    ...
    private void btnIniciaSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciaSesionActionPerformed
        ...
        String contrasena=new String(txtcontraLogin.getPassword());
        
        if (txtUSuarioLogin.getText().equals("") || contrasena.equals("")){
            JOptionPane.showMessageDialog(null, "Por favor rellene todos los campos");
        }else{
            String nuevaContrasena=CifrarClave.md5(contrasena);
            usuario.setNombreUsuario(txtUSuarioLogin.getText());
